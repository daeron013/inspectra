...
var n = "memory";
var o = { name: "auth0-spa-js", version: "2.18.0" };
var r = () => Date.now();
var i = "default";
var a = class _a2 extends Error {
  constructor(e3, t2) {
    super(t2), this.error = e3, this.error_description = t2, Object.setPrototypeOf(this, _a2.prototype);
  }
  static fromPayload(e3) {
    let { error: t2, error_description: n2 } = e3;
    return new _a2(t2, n2);
  }
};
...
var v = () => {
  ...
  let t2 = "";
  for (; t2.length < 43; ) {
    const n2 = g().getRandomValues(new Uint8Array(43 - t2.length));
  ...
  return e3.prototype.acquireLock = function(t2, n2) {
    return void 0 === n2 && (n2 = 5e3), O(this, void 0, void 0, function() {
      ...
      return C(this, function(l2) {
        switch (l2.label) {
          case 0:
            o2 = Date.now() + L(4), r2 = Date.now() + n2, i2 = U + "-" + t2, a2 = void 0 === this.storageHandler ? W : this.storageHandler, l2.label = 1;
          case 1:
          ...
          case 5:
            return e3.lockCorrector(void 0 === this.storageHandler ? W : this.storageHandler), [4, this.waitForSomethingToChange(r2)];
          case 6:
            l2.sent(), l2.label = 7;
          case 7:
          ...
          return O(n2, void 0, void 0, function() {
            ...
            return C(this, function(i2) {
              switch (i2.label) {
                ...
                case 1:
                  return i2.sent(), this.acquiredIatSet.has(t2) ? (n3 = void 0 === this.storageHandler ? W : this.storageHandler, null === (o3 = n3.getItemSync(e4)) ? (D.default().unlock(t2), [2]) : ((r2 = JSON.parse(o3)).timeRefreshed = Date.now(), n3.setItemSync(e4, JSON.stringify(r2)), D.default().unlock(t2), this.refreshLockWhileAcquired(e4, t2), [2])) : (D.default().unlock(t2), [2]);
              }
            });
          });
        }, 1e3), [2];
    ...
    return O(this, void 0, void 0, function() {
      ...
      return C(this, function(a2) {
        switch (a2.label) {
          case 0:
            return n2 = void 0 === this.storageHandler ? W : this.storageHandler, o2 = U + "-" + t2, null === (r2 = n2.getItemSync(o2)) ? [2] : (i2 = JSON.parse(r2)).id !== this.id ? [3, 2] : [4, D.default().lock(i2.iat)];
          case 1:
...
var H = class {
  constructor() {
    this.activeLocks = /* @__PURE__ */ new Set(), this.lock = new M(), this.pagehideHandler = () => {
...
async function fe(t2, n2, o2, r2, i2, s2, c2, u2, l2, h2) {
  ...
  if (m2) throw m2;
  const w2 = d2.json, { error: g2, error_description: v2 } = w2, b2 = e(w2, ["error", "error_description"]), { headers: _2, ok: k2 } = d2;
  let S2;
...
async function me(t2, n2) {
  ...
  const f2 = "urn:ietf:params:oauth:grant-type:token-exchange" === p2.grant_type, m2 = "refresh_token" === p2.grant_type && h2, y2 = Object.assign(Object.assign(Object.assign(Object.assign({}, p2), f2 && s2 && { audience: s2 }), f2 && c2 && { scope: c2 }), m2 && { audience: s2, scope: c2 }), w2 = l2 ? S(y2) : JSON.stringify(y2), g2 = (v2 = p2.grant_type, ae.includes(v2));
  var v2;
...
var xe = A && A.__assign || function() {
  return xe = Object.assign || function(e3) {
...
function Re(e3, t2, n2) {
  return encodeURIComponent(e3).replace(/%(23|24|26|2B|5E|60|7C)/g, decodeURIComponent).replace(/\(/g, "%28").replace(/\)/g, "%29") + "=" + encodeURIComponent(t2).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g, decodeURIComponent) + function(e4) {
    ...
    return Ie("Expires", e4.expires ? e4.expires.toUTCString() : "") + Ie("Domain", e4.domain) + Ie("Path", e4.path) + Ie("Secure", e4.secure) + Ie("SameSite", e4.sameSite);
  }(n2);
}
function Oe() {
  return function(e3) {
...
function je(e3, t2, n2) {
  document.cookie = Re(e3, t2, xe({ path: "/" }, n2));
}
var De = je;
var Ue = function(e3, t2) {
  je(e3, "", xe(xe({}, t2), { expires: -1 }));
};
var We = { get(e3) {
  const t2 = Ce(e3);
  ...
  let n2 = {};
  (null == t2 ? void 0 : t2.cookieDomain) && (n2.domain = t2.cookieDomain), Ue(e3, n2);
} };
var Ke = "_legacy_";
var Le = { get(e3) {
  const t2 = We.get(e3);
  return t2 || We.get("".concat(Ke).concat(e3));
}, save(e3, t2, n2) {
  let o2 = {};
  "https:" === window.location.protocol && (o2 = { secure: true }), (null == n2 ? void 0 : n2.daysUntilExpire) && (o2.expires = n2.daysUntilExpire), (null == n2 ? void 0 : n2.cookieDomain) && (o2.domain = n2.cookieDomain), De("".concat(Ke).concat(e3), JSON.stringify(t2), o2), We.save(e3, t2, n2);
}, remove(e3, t2) {
  let n2 = {};
  (null == t2 ? void 0 : t2.cookieDomain) && (n2.domain = t2.cookieDomain), Ue(e3, n2), We.remove(e3, t2), We.remove("".concat(Ke).concat(e3), t2);
} };
var Ne = { get(e3) {
...
function Tt(e3) {
  ...
  function r2(e4, r3) {
    2 === e4 ? t2.reject(r3) : t2.resolve({ value: r3, done: e4 }), (t2 = t2.next) ? o2(t2.key, t2.arg) : n2 = null;
  }
...
var Nt = new TextDecoder();
function Mt(e3) {
  return "string" == typeof e3 ? Lt.encode(e3) : Nt.decode(e3);
}
var zt;
var Ht;
...
Ht = Uint8Array.fromBase64 ? (e3) => {
  try {
    ...
    throw Ot("The input to be decoded is not correctly encoded.", It, e4);
  }
} : (e3) => {
  try {
...
function qt(e3, t2) {
  ...
  }(e3, t2), "private" !== e3.type) throw Ot("".concat(t2, " must be a private CryptoKey"), It);
}
function Xt(e3) {
...
function Gt(e3) {
  ...
  if (At && !t2.has("user-agent") && t2.set("user-agent", At), t2.has("authorization")) throw Ot('"options.headers" must not include the "authorization" header name', It);
  return t2;
}
function Bt(e3, t2) {
  if (void 0 !== t2) {
...
async function Qt(e3, t2) {
  return async function(e4, t3, n2, o2) {
    ...
    return i2.set("accept", "application/json"), ((null == o2 ? void 0 : o2[Ut]) || fetch)(r2.href, { body: void 0, headers: Object.fromEntries(i2.entries()), method: "GET", redirect: "manual", signal: Bt(r2, null == o2 ? void 0 : o2.signal) });
    ...
    switch (null == t2 ? void 0 : t2.algorithm) {
      ...
      case "oauth2":
        ...
        break;
      default:
        throw Ot('"options.algorithm" must be "oidc" (default), or "oauth2"', It);
    }
    return e4;
  }, t2);
}
function $t(e3, t2, n2, o2, r2) {
  try {
    ...
    if (e3 > 0) return;
    if (t2) {
      if (0 !== e3) throw Ot("".concat(n2, " must be a non-negative number"), It, r2);
      return;
    }
    throw Ot("".concat(n2, " must be a positive number"), It, r2);
  } catch (e4) {
...
function en(e3, t2, n2, o2) {
  try {
    ...
    if (0 === e3.length) throw Ot("".concat(t2, " must not be empty"), It, o2);
  } catch (e4) {
...
function hn(e3, t2) {
  ...
  return qt(n2, '"clientPrivateKey.key"'), async (e4, r3, i2, a2) => {
    ...
    null == t2 || null === (s2 = t2[Wt]) || void 0 === s2 || s2.call(t2, c2, u2), i2.set("client_id", r3.client_id), i2.set("client_assertion_type", "urn:ietf:params:oauth:client-assertion-type:jwt-bearer"), i2.set("client_assertion", await async function(e5, t3, n3) {
      if (!n3.usages.includes("sign")) throw Ot('CryptoKey instances used for signing assertions must include "sign" in their "usages"', It);
      const o3 = "".concat(Jt(Mt(JSON.stringify(e5))), ".").concat(Jt(Mt(JSON.stringify(t3)))), r4 = Jt(await crypto.subtle.sign(function(e6) {
...
async function Pn(e3, t2, n2) {
  if (e3.status !== t2) {
    ...
    if (function(e4) {
      let t4;
      if (t4 = function(e5) {
        if (!xt(e5, Response)) throw Ot('"response" must be an instance of Response', Rt);
...
function An(e3) {
  if (!Kn.has(e3)) throw Ot('"options.DPoP" is not a valid DPoPHandle', It);
}
function xn(e3) {
  var t2;
  return null === (t2 = e3.headers.get("content-type")) || void 0 === t2 ? void 0 : t2.split(";")[0];
}
async function In(e3, t2, n2, o2, r2, i2, a2) {
  return await n2(e3, t2, r2, i2), i2.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"), ((null == a2 ? void 0 : a2[Ut]) || fetch)(o2.href, { body: r2, headers: Object.fromEntries(i2.entries()), method: "POST", redirect: "manual", signal: Bt(o2, null == a2 ? void 0 : a2.signal) });
}
async function Rn(e3, t2, n2, o2, r2, i2) {
  ...
  const u2 = await In(e3, t2, n2, s2, r2, c2, i2);
...
function jn(e3) {
  ...
  const t2 = On.get(e3);
  if (!t2) throw Ot('"ref" was already garbage collected or did not resolve from the proper sources', It);
  return t2;
}
async function Dn(e3, t2, n2, o2, r2, i2) {
  if (cn(e3), un(t2), !xt(n2, Response)) throw Ot('"response" must be an instance of Response', Rt);
  ...
  if (void 0 !== a2.id_token) {
    ...
    }(a2.id_token, uo.bind(void 0, t2.id_token_signed_response_alg, e3.id_token_signing_alg_values_supported, "RS256"), rn(t2), an(t2), r2).then(Mn.bind(void 0, i3)).then(Wn.bind(void 0, e3)).then(Un.bind(void 0, t2.client_id));
...
var Ln = Symbol();
var Nn = { aud: "audience", c_hash: "code hash", client_id: "client id", exp: "expiration time", iat: "issued at", iss: "issuer", jti: "jwt id", nonce: "nonce", s_hash: "state hash", sub: "subject", ath: "access token hash", htm: "http method", htu: "http uri", cnf: "confirmation", auth_time: "authentication time" };
function Mn(e3, t2) {
  for (const n2 of e3) if (void 0 === t2.claims[n2]) throw Vt('JWT "'.concat(n2, '" (').concat(Nn[n2], ") claim missing"), Gn, { claims: t2.claims });
  return t2;
}
var zn = Symbol();
var Hn = Symbol();
...
function io(e3) {
  if (e3.bodyUsed) throw Ot('"response" body has been used already', It);
}
function ao(e3) {
...
async function co(e3) {
  if ("POST" !== e3.method) throw Ot("form_post responses are expected to use the POST method", It, { cause: e3 });
  if ("application/x-www-form-urlencoded" !== xn(e3)) throw Ot("form_post responses are expected to use the application/x-www-form-urlencoded content-type", It, { cause: e3 });
  return async function(e4) {
    if (e4.bodyUsed) throw Ot("form_post Request instances must contain a readable body", It, { cause: e4 });
    return e4.text();
  }(e3);
}
...
vt(Mo, "code", "ERR_JWS_SIGNATURE_VERIFICATION_FAILED");
var zo = (e3) => {
  ...
  switch (e3.substring(0, 2)) {
    ...
    case "PB":
      ((e4, t3, n3) => {
        if (!(t3 instanceof Uint8Array)) {
          ...
          if (!Jo(t3)) throw new TypeError(xo(e4, t3, "CryptoKey", "KeyObject", "JSON Web Key", "Uint8Array"));
    ...
    default:
      ((e4, t3, n3) => {
        ...
        if (!Jo(t3)) throw new TypeError(xo(e4, t3, "CryptoKey", "KeyObject", "JSON Web Key"));
...
function Sr(e3) {
  return async function(e4) {
    return en(e4, "codeVerifier"), Jt(await crypto.subtle.digest("SHA-256", Mt(e4)));
  }(e3);
}
function Tr() {
  return nn();
...
async function xr(e3, t2, n2, o2, r2) {
  const i2 = await async function(e4, t3) {
    ...
    const r3 = !e4.href.includes("/.well-known/"), i3 = null !== (n3 = null == t3 ? void 0 : t3.timeout) && void 0 !== n3 ? n3 : 30, a3 = AbortSignal.timeout(1e3 * i3), s3 = await (r3 ? Qt(e4, { algorithm: null == t3 ? void 0 : t3.algorithm, [Ut]: null == t3 ? void 0 : t3[vr], [Ct]: null == t3 || null === (o3 = t3.execute) || void 0 === o3 ? void 0 : o3.includes(Wr), signal: a3, headers: new Headers(pr) }) : ((null == t3 ? void 0 : t3[vr]) || fetch)((pn(e4, null == t3 || null === (c2 = t3.execute) || void 0 === c2 || !c2.includes(Wr)), e4.href), { headers: Object.fromEntries(new Headers(_t({ accept: "application/json" }, pr)).entries()), body: void 0, method: "GET", redirect: "manual", signal: a3 })).then((e5) => async function(e6, t4) {
      const n4 = e6;
      if (!(n4 instanceof URL) && n4 !== yo) throw Ot('"expectedIssuerIdentifier" must be an instance of URL', Rt);
      if (!xt(t4, Response)) throw Ot('"response" must be an instance of Response', Rt);
...
async function Dr(e3, t2) {
  ...
  return async function(e4, t3, n3, o3, r3) {
    ...
    return s3.set("accept", "application/json"), In(e4, t3, n3, i3, a3, s3, r3);
  }(n2, o2, r2, t2, { [Ut]: i2, [Ct]: !a2, headers: new Headers(pr), signal: Jr(s2) }).then((e4) => async function(e5, t3, n3) {
    if (cn(e5), un(t3), !xt(n3, Response)) throw Ot('"response" must be an instance of Response', Rt);
...
async function Ur(e3, t2, n2, o2) {
  ...
  const { as: c2, c: u2, auth: l2, fetch: h2, tlsOnly: d2, nonRepudiation: p2, timeout: f2, decrypt: m2 } = mr(e3), y2 = (r3, i3) => Ur(e3, _t(_t({}, t2), {}, { interval: r3 }), n2, _t(_t({}, o2), {}, { signal: s2, flag: i3 })), w2 = await async function(e4, t3, n3, o3, r3) {
  ...
  }(c2, u2, l2, t2.auth_req_id, { [Ut]: h2, [Ct]: !d2, additionalParameters: n2, DPoP: null == o2 ? void 0 : o2.DPoP, headers: new Headers(pr), signal: s2.aborted ? s2 : Jr(f2) }).catch(Ar);
  var g2;
...
async function Kr(e3, t2, n2, o2, r2) {
  ...
  const g2 = await async function(e4, t3, n3, o3, r3, i3, a3) {
    if (cn(e4), un(t3), !Kn.has(o3)) throw Ot('"callbackParameters" must be an instance of URLSearchParams obtained from "validateAuthResponse()", or "validateJwtAuthResponse()', It);
    en(r3, '"redirectUri"');
    const s3 = lo(o3, "code");
  ...
  }(s2, c2, u2, i2, a2, (null == n2 ? void 0 : n2.pkceCodeVerifier) || Ln, { additionalParameters: o2, [Ut]: l2, [Ct]: !h2, DPoP: null == r2 ? void 0 : r2.DPoP, headers: new Headers(pr), signal: Jr(m2) }).catch(Ar);
  "string" != typeof (null == n2 ? void 0 : n2.expectedNonce) && "number" != typeof (null == n2 ? void 0 : n2.maxAge) || (n2.idTokenExpected = true);
  const v2 = Jn(s2, c2, g2, { expectedNonce: null == n2 ? void 0 : n2.expectedNonce, maxAge: null == n2 ? void 0 : n2.maxAge, requireIdToken: null == n2 ? void 0 : n2.idTokenExpected, [Kt]: y2 });
  let b2;
  try {
    b2 = await v2;
  } catch (t3) {
...
async function Lr(e3, t2, n2, o2) {
  ...
  }(r2, i2, a2, t2, { [Ut]: s2, [Ct]: !c2, additionalParameters: n2, DPoP: null == o2 ? void 0 : o2.DPoP, headers: new Headers(pr), signal: Jr(l2) }).catch(Ar), p2 = async function(e4, t3, n3, o3) {
    return Dn(e4, t3, n3, void 0, null == o3 ? void 0 : o3[Kt], null == o3 ? void 0 : o3.recognizedTokenTypes);
  }(r2, i2, d2, { [Kt]: h2 });
  let f2;
  try {
...
async function Nr(e3, t2, n2) {
  ...
  }(o2, r2, i2, t2, { [Ut]: a2, [Ct]: !s2, DPoP: null == n2 ? void 0 : n2.DPoP, headers: new Headers(pr), signal: Jr(c2) }).catch(Ar), l2 = async function(e4, t3, n3, o3) {
    return Dn(e4, t3, n3, void 0, null == o3 ? void 0 : o3[Kt], null == o3 ? void 0 : o3.recognizedTokenTypes);
  }(o2, r2, u2);
  let h2;
  try {
    ...
    if (Zr(o3, n2)) return Nr(e3, t2, _t(_t({}, n2), {}, { flag: Fr }));
    Ar(o3);
  }
  return Or(h2), h2;
}
...
async function zr(e3, t2, n2) {
  Hr(e3);
  const o2 = Mr(e3, t2), { as: r2, c: i2, auth: a2, fetch: s2, tlsOnly: c2, timeout: u2 } = mr(e3), l2 = await async function(e4, t3, n3, o3, r3) {
    var i3;
    cn(e4), un(t3);
    ...
    const u3 = await In(e4, t3, n3, a3, s3, c3, r3);
    return null == r3 || null === (i3 = r3.DPoP) || void 0 === i3 || i3.cacheNonce(u3, a3), u3;
  }(r2, i2, a2, o2.searchParams, { [Ut]: s2, [Ct]: !c2, DPoP: null == n2 ? void 0 : n2.DPoP, headers: new Headers(pr), signal: Jr(u2) }).catch(Ar), h2 = async function(e4, t3, n3) {
    if (cn(e4), un(t3), !xt(n3, Response)) throw Ot('"response" must be an instance of Response', Rt);
  ...
  return Mr(e3, { request_uri: d2.request_uri });
}
function Hr(e3) {
...
async function Vr(e3, t2, n2, o2) {
  ...
  }(r2, i2, a2, t2, new URLSearchParams(n2), { [Ut]: s2, [Ct]: !c2, DPoP: null == o2 ? void 0 : o2.DPoP, headers: new Headers(pr), signal: Jr(u2) }).then((e4) => {
    let n3;
...
async function qr(e3, t2, n2) {
  ...
  if (!await Xo(s2, d2, h2, l2)) throw new Mo();
  let p2;
...
var ii = class {
  constructor(e3) {
    ...
    }(e3)) throw new Wo("JSON Web Key Set malformed");
...
async function ai(e3, t2, n2) {
  ...
  if (void 0 === o2[n2]) {
    ...
    if (e4 instanceof Uint8Array || "public" !== e4.type) throw new Wo("JSON Web Key Set members must be public keys");
    o2[n2] = e4;
  }
  return o2[n2];
}
  ...
  async reload() {
    yt(yi, this) && ("undefined" != typeof WebSocketPair || "undefined" != typeof navigator && "Cloudflare-Workers" === navigator.userAgent || "undefined" != typeof EdgeRuntime && "vercel" === EdgeRuntime) && gt(yi, this, void 0), yt(yi, this) || gt(yi, this, async function(e3, t2, n2) {
      ...
      const r2 = await o2(e3, { method: "GET", signal: n2, redirect: "manual", headers: t2 }).catch((e4) => {
        if ("TimeoutError" === e4.name) throw new No();
        throw e4;
      });
      if (200 !== r2.status) throw new Io("Expected 200 OK from the JSON Web Key Set HTTP response");
      try {
        return await r2.json();
      } catch (e4) {
        throw new Io("Failed to parse the JSON Web Key Set HTTP response as JSON");
      }
...
var ca = (Ai = /* @__PURE__ */ new WeakMap(), xi = /* @__PURE__ */ new WeakMap(), Ii = /* @__PURE__ */ new WeakMap(), class {
  constructor(e3, t2) {
    wt(this, Ai, /* @__PURE__ */ new Map()), wt(this, xi, void 0), wt(this, Ii, void 0), gt(Ii, this, Math.max(1, Math.floor(e3))), gt(xi, this, Math.max(0, Math.floor(t2)));
  }
  get(e3) {
  ...
  set(e3, t2) {
    for (yt(Ai, this).has(e3) && yt(Ai, this).delete(e3), yt(Ai, this).set(e3, { value: t2, expiresAt: Date.now() + yt(xi, this) }); yt(Ai, this).size > yt(Ii, this); ) {
...
var wa = (Ri = /* @__PURE__ */ new WeakMap(), Oi = /* @__PURE__ */ new WeakMap(), Ci = /* @__PURE__ */ new WeakMap(), ji = /* @__PURE__ */ new WeakMap(), Di = /* @__PURE__ */ new WeakMap(), Ui = /* @__PURE__ */ new WeakMap(), Wi = /* @__PURE__ */ new WeakMap(), Ki = /* @__PURE__ */ new WeakMap(), Li = /* @__PURE__ */ new WeakMap(), Ni = /* @__PURE__ */ new WeakSet(), class {
  constructor(e3) {
    var t2, n2, o2, r2;
    if (function(e4, t3) {
      mt(e4, t3), t3.add(e4);
    }(this, Ni), wt(this, Ri, void 0), wt(this, Oi, void 0), wt(this, Ci, void 0), wt(this, ji, void 0), wt(this, Di, void 0), wt(this, Ui, void 0), wt(this, Wi, void 0), wt(this, Ki, void 0), wt(this, Li, void 0), vt(this, "mfa", void 0), gt(ji, this, e3), e3.useMtls && !e3.customFetch) throw new Mi("mtls_without_custom_fetch_not_supported", "Using mTLS without a custom fetch implementation is not supported");
    ...
    gt(Wi, this, ha.createDiscoveryCache(i2)), gt(Ki, this, /* @__PURE__ */ new Map()), gt(Li, this, ha.createJwksCache()), this.mfa = new aa({ domain: yt(ji, this).domain, clientId: yt(ji, this).clientId, customFetch: yt(Di, this) });
  }
  async getServerMetadata() {
    const { serverMetadata: e3 } = await pt(Ni, this, ba).call(this);
    return e3;
  }
  async buildAuthorizationUrl(e3) {
    const { serverMetadata: t2 } = await pt(Ni, this, ba).call(this);
    ...
    try {
      return await pt(Ni, this, Ta).call(this, e3);
    } catch (e4) {
      throw new Gi(e4);
    }
  }
  async buildLinkUserUrl(e3) {
    try {
      const t2 = await pt(Ni, this, Ta).call(this, { authorizationParams: _t(_t({}, e3.authorizationParams), {}, { requested_connection: e3.connection, requested_connection_scope: e3.connectionScope, scope: "openid link_account offline_access", id_token_hint: e3.idToken }) });
  ...
  async buildUnlinkUserUrl(e3) {
    try {
      const t2 = await pt(Ni, this, Ta).call(this, { authorizationParams: _t(_t({}, e3.authorizationParams), {}, { requested_connection: e3.connection, scope: "openid unlink_account", id_token_hint: e3.idToken }) });
  ...
  async backchannelAuthentication(e3) {
    ...
    try {
      const e4 = await Dr(t2, r2), n3 = await Ur(t2, e4);
  ...
  async backchannelAuthenticationGrant(e3) {
    let { authReqId: t2 } = e3;
    const { configuration: n2 } = await pt(Ni, this, ba).call(this), o2 = new URLSearchParams({ auth_req_id: t2 });
    try {
  ...
  async exchangeToken(e3) {
    return "connection" in e3 ? pt(Ni, this, _a).call(this, e3) : pt(Ni, this, ka).call(this, e3);
  }
  async getTokenByCode(e3, t2) {
    const { configuration: n2 } = await pt(Ni, this, ba).call(this);
    try {
  ...
  async getTokenByRefreshToken(e3) {
    const { configuration: t2 } = await pt(Ni, this, ba).call(this), n2 = new URLSearchParams();
  ...
  async buildLogoutUrl(e3) {
    const { configuration: t2, serverMetadata: n2 } = await pt(Ni, this, ba).call(this);
  ...
  async verifyLogoutToken(e3) {
    const { serverMetadata: t2 } = await pt(Ni, this, ba).call(this), n2 = la(yt(ji, this).discoveryCache), o2 = t2.jwks_uri;
    yt(Ui, this) || gt(Ui, this, function(e4, t3) {
    ...
    const { payload: r2 } = await $r(e3.logoutToken, yt(Ui, this), { issuer: t2.issuer, audience: yt(ji, this).clientId, algorithms: ["RS256"], requiredClaims: ["iat"] });
...
async function va(e3) {
  const t2 = await pt(Ni, this, Sa).call(this), n2 = new Rr(e3, yt(ji, this).clientId, yt(ji, this).clientSecret, t2);
  return n2[vr] = yt(Di, this), n2;
}
async function ba() {
  if (yt(Ri, this) && yt(Oi, this)) return { configuration: yt(Ri, this), serverMetadata: yt(Oi, this) };
  const e3 = pt(Ni, this, ga).call(this), t2 = yt(Wi, this).get(e3);
  if (t2) return gt(Oi, this, t2.serverMetadata), gt(Ri, this, await pt(Ni, this, va).call(this, t2.serverMetadata)), { configuration: yt(Ri, this), serverMetadata: yt(Oi, this) };
  const n2 = yt(Ki, this).get(e3);
  if (n2) {
    const e4 = await n2;
    return gt(Oi, this, e4.serverMetadata), gt(Ri, this, await pt(Ni, this, va).call(this, e4.serverMetadata)), { configuration: yt(Ri, this), serverMetadata: yt(Oi, this) };
  }
  const o2 = (async () => {
    const t3 = await pt(Ni, this, Sa).call(this), n3 = await xr(new URL("https://".concat(yt(ji, this).domain)), yt(ji, this).clientId, { use_mtls_endpoint_aliases: yt(ji, this).useMtls }, t3, { [vr]: yt(Di, this) }), o3 = n3.serverMetadata();
    return yt(Wi, this).set(e3, { serverMetadata: o3 }), { configuration: n3, serverMetadata: o3 };
  })(), r2 = o2.then((e4) => {
...
async function _a(e3) {
  var t2, n2;
  const { configuration: o2 } = await pt(Ni, this, ba).call(this);
...
async function Ta(e3) {
  const { configuration: t2 } = await pt(Ni, this, ba).call(this), n2 = Tr(), o2 = await Sr(n2), r2 = $i(_t(_t({}, yt(ji, this).authorizationParams), null == e3 ? void 0 : e3.authorizationParams)), i2 = new URLSearchParams(_t(_t({ scope: da }, r2), {}, { client_id: yt(ji, this).clientId, code_challenge: o2, code_challenge_method: "S256" }));
  return { authorizationUrl: null != e3 && e3.pushedAuthorizationRequests ? await zr(t2, i2) : await Mr(t2, i2), codeVerifier: n2 };
}
...
var Ca = class {
  ...
  async challenge(e3) {
    ...
    try {
      ...
      if (e4 instanceof ra) throw new xa(null === (t2 = e4.cause) || void 0 === t2 ? void 0 : t2.error, e4.message);
      throw e4;
    }
  }
...
var ja = class {
  ...
  async loginWithPopup(e3, t2) {
    ...
    const i2 = await ((e4) => new Promise((t3, n3) => {
      ...
      o3 = function(s3) {
        if (s3.data && "authorization_response" === s3.data.type) {
          if (clearTimeout(i3), clearInterval(r3), window.removeEventListener("message", o3, false), false !== e4.closePopup && e4.popup.close(), s3.data.response.error) return n3(a.fromPayload(s3.data.response));
          t3(s3.data.response);
        }
    ...
    if (r2.state !== i2.state) throw new a("state_mismatch", "Invalid state");
    const s2 = (null === (n2 = e3.authorizationParams) || void 0 === n2 ? void 0 : n2.organization) || this.options.authorizationParams.organization;
    await this._requestToken({ audience: r2.audience, scope: r2.scope, code_verifier: r2.code_verifier, grant_type: "authorization_code", code: i2.code, redirect_uri: r2.redirect_uri }, { nonceIn: r2.nonce, organization: s2 });
  }
  async getUser() {
    var e3;
  ...
  async handleRedirectCallback() {
    ...
    return t2.response_type === Me.ConnectCode ? this._handleConnectAccountRedirectCallback(n2, t2) : this._handleLoginRedirectCallback(n2, t2);
  }
  async _handleLoginRedirectCallback(e3, t2) {
    ...
    return await this._requestToken(Object.assign({ audience: t2.audience, scope: t2.scope, code_verifier: t2.code_verifier, grant_type: "authorization_code", code: n2 }, l2 ? { redirect_uri: l2 } : {}), { nonceIn: u2, organization: c2 }), { appState: t2.appState, response_type: Me.Code };
  }
  async _handleConnectAccountRedirectCallback(e3, t2) {
    ...
    return Object.assign(Object.assign({}, s2), { appState: t2.appState, response_type: Me.ConnectCode });
  }
  ...
  async connectAccountWithRedirect(e3) {
    ...
    const s2 = b(v()), c2 = v(), u2 = await T(c2), l2 = P(u2), { connect_uri: h2, connect_params: d2, auth_session: p2 } = await this.myAccountApi.connectAccount({ connection: o2, scopes: r2, redirect_uri: a2, state: s2, code_challenge: l2, code_challenge_method: "S256", authorization_params: i2 });
    this.transactionManager.create({ state: s2, code_verifier: c2, auth_session: p2, redirect_uri: a2, appState: n2, connection: o2, response_type: Me.ConnectCode });
    const f2 = new URL(h2);
...
var Auth0Provider = function(opts) {
  ...
  var client = (0, import_react.useState)(function() {
    return providedClient !== null && providedClient !== void 0 ? providedClient : new ja(toAuth0ClientOptions(clientOpts));
  })[0];
        ...
        return __generator(this, function(_c2) {
          switch (_c2.label) {
            ...
            case 2:
              ...
              if (response_type === Me.ConnectCode) {
...
export {
  Auth0Context,
  Auth0Provider,
  s as AuthenticationError,
  c as ConnectError,
  a as GenericError,
  ke as InMemoryCache,
  _e as LocalStorageCache,
  xa as MfaChallengeError,
  Aa as MfaEnrollmentError,
  Ra as MfaEnrollmentFactorsError,
  Ea as MfaError,
  Pa as MfaListAuthenticatorsError,
  p as MfaRequiredError,
  Ia as MfaVerifyError,
  f as MissingRefreshTokenError,
  OAuthError,
  h as PopupCancelledError,
  d as PopupOpenError,
  l as PopupTimeoutError,
  Me as ResponseType,
  u as TimeoutError,
  y as UseDpopNonceError,
  ze as User,
  initialContext,
  useAuth0,
  withAuth0,
